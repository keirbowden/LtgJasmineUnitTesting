<aura:application >
    ...
    <aura:registerEvent name="JobInitEvent" type="c:SAMP_JobInitEvent" />
                ...
                <div class="slds-col slds-has-flexi-truncate">
                    <div class="slds-media">
                        <div class="slds-media__figure">
                            <c:LJUT_SVG ariahidden="true" class="slds-icon slds-icon--large slds-icon-standard-news"
                ...
                <div class="slds-small-show slds-col slds-no-flex slds-align-bottom">
                    <button class="slds-button slds-button--neutral slds-not-selected" aria-live="assertive"
                        ...
                        <span class="slds-text-not-selected">
                            <c:LJUT_SVG ariahidden="true" class="slds-button__icon"
